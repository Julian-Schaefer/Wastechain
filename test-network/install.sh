...
docker exec cli peer chaincode instantiate -n Wastechain -v 0 -l node -c '{"Args":["checkIfWasteOrderExists", "test001"]}' -C wastechain -P "OR('OrderingOrgMSP.peer', 'SubcontractorOrgMSP.peer', 'ThirdPartyOrgMSP.peer')"