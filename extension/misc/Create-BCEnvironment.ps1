...
New-NavContainer -containerName OrderingOrg -accept_eula -imageName "mcr.microsoft.com/businesscentral/onprem:14.1.32615.0" -useBestContainerOS -bakFile "C:\Users\JSchaefer\Documents\Backup\BC140-Wastechain.bak"
