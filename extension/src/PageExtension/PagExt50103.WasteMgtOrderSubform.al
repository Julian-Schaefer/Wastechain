pageextension 50103 "Waste Mgt Order Subform Ext WC" extends "Waste Mgt. Order Subform WMR"
{
    actions
    {
        addlast(processing)
            ...
            group(Wastechain)
            {
                action("Commission Waste Order WC")
                {
                    ...
                    var
                        ...
                        CantMakeChangesErr: Label 'You cannot correct a Waste Order with Status: %1';
                    begin
                        if "Waste Order ID WC" = '' then begin
                            ...
                            WastechainMgt.CorrectWasteOrder(Rec);
                        end;
                    end;
                }
